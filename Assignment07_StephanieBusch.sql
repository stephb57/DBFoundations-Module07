...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_StephanieBusch')
	 Begin 
	  Alter Database [Assignment07DB_StephanieBusch] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_StephanieBusch;
	 End
	Create Database Assignment07DB_StephanieBusch;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_StephanieBusch;
...
IF OBJECT_ID('vInventories') IS NOT NULL DROP VIEW vInventories;
IF OBJECT_ID('vEmployees') IS NOT NULL DROP VIEW vEmployees;
IF OBJECT_ID('vProducts') IS NOT NULL DROP VIEW vProducts;
IF OBJECT_ID('vCategories') IS NOT NULL DROP VIEW vCategories;
GO
...
-- <Put Your Code Here> --
IF OBJECT_ID('vProductInventories') IS NOT NULL DROP VIEW vProductInventories;
GO
